...
/* Modifications made by Ryan Cramer on lines indicated with "RJC" */
var HotelDatepicker = (function (fecha) {
    ...
    class HotelDatepicker {
      constructor(input, options) {
        ...
        this.minNights = opts.minNights || 0; // RJC
      ...
      init() {
        ...
        this.minDays = this.minNights > 0 ? this.minNights + 1 : 1; // RJC

        // Set the maximum of days required by the daterange
        this.maxDays = this.maxNights > 0 ? this.maxNights + 1 : 0;
        if(this.maxNights < 0) this.maxDays = 1; // RJC
      ...
      dayClicked(day) {
        ...
        if (this.onDayClick) {
          this.onDayClick(day); // RJC added 'day'
        }

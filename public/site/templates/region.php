...
$regionStoryBySlug = [
	'respublika-dagestan' => [
		'lead' => 'Дагестан объединяет морское побережье, каньоны и высокогорные аулы: здесь в одном туре можно увидеть сразу несколько климатических зон.',
		'paragraphs' => [
	...
	'respublika-ingushetiya' => [
		'lead' => 'Ингушетия — регион компактных, но очень выразительных маршрутов: башенные комплексы, ущелья и спокойный темп тура.',
		'paragraphs' => [
			'Ключевые точки сосредоточены в Джейрахском районе, поэтому логистика для коротких туров удобная и позволяет увидеть много за 2-3 дня.',
			'Тур сюда хорошо подходит для культурно-исторического туризма и треков средней сложности по горным долинам.',
		],
		'facts' => [
	...
	'chechenskaya-respublika' => [
		...
		'paragraphs' => [
			...
			'Это направление удобно для комбинированных туров: часть маршрута в городе, часть — в горах с насыщенной природной программой.',
		],
		'facts' => [
	...
	'kabardino-balkarskaya-respublika' => [
		...
		'paragraphs' => [
			'Регион позволяет собрать программу под любой уровень подготовки: канатные дороги, треккинг, водопады и ущелья в рамках одного тура.',
	...
	'karachaevo-cherkesskaya-respublika' => [
		...
		'paragraphs' => [
			...
			'Это направление часто выбирают для семейных туров и коротких выездов на 3-4 дня благодаря развитой туристической базе.',
		],
		'facts' => [
	...
	'stavropolskiy-kray' => [
		'lead' => 'Ставропольский край — комфортная база для спокойного отдыха, санаторного формата и туров по городам КМВ.',
		'paragraphs' => [
			...
			'Регион хорошо подходит для семейных и оздоровительных туров, а также как точка старта для выездов в горные районы соседних республик.',
		],
		'facts' => [
...
$regionStory = $regionStoryBySlug[$page->name] ?? [
	...
	'paragraphs' => [
		"Сценарий тура по {$regionLabel} можно собрать под любой темп: от спокойных прогулок до полноценной активной программы.",
		'В карточках ниже собраны ключевые маршруты, места и материалы для подготовки к туру.',
	],
	'facts' => [
